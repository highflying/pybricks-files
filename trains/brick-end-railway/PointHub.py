...
class PointHub(object):
    def __init__(self, point_channel, remote_name):
        self.remote_name = remote_name
        self.direction = Messages.Straight
        self.point_channel = point_channel
        self._hub = TechnicHub(broadcast_channel=point_channel)

        self.connect_remote()

        self.point = Point(Port.A)
        self.power = 90
